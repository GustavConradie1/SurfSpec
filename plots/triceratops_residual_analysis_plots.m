...
exportgraphics(gcf,'schr_tric_res_eval.pdf','ContentType','vector','BackgroundColor','none')

%% residuals w order of mesh
load('tric_residuals_order.mat')
figure
...
ylim([10^(-4) 310])
exportgraphics(gcf,'schr_tric_res_order.pdf','ContentType','vector','BackgroundColor','none')

%% residuals w number of nodes
load('tric_residuals_nodes.mat')
figure
node_range=2:2:20;
...
xticks([2 8 14 20])
axis([2 20 0 0.08])
exportgraphics(gcf,'schr_tric_res_nodes.pdf','ContentType','vector','BackgroundColor','none')