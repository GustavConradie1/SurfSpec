function [D,F,res] = schrSpec(surf,bndry,pot,varargin)
    %calculate eigenvalues, eigenfunction and residuals of Schrodinger
    %operator -Lap + pot(x,y,z) on given surfaces
    %arguments same as lapSpec but with addition of pot for the potential
    p=inputParser;
