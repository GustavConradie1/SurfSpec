function [D,F,res] = lapSpec2(surf,bndry,varargin)
    %same as lapSpec but here we assume that we have
    %symmetry allowing us to use only the upper half plane for contours
    p=inputParser;
